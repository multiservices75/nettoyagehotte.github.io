# HOTTE-NETT · Nettoyage Hotte Restaurant

Site vitrine statique — prêt à déployer sur GitHub Pages.

## URL de production
https://multiservices75.github.io/hotte/
...
1. Crée un nouveau repo GitHub nommé **`hotte`** (public)
2. Glisse-dépose TOUT le contenu de ce dossier à la racine du repo → Commit
3. **Settings → Pages → Branch: `main` / (root) → Save**
4. Attends ~1 minute → ton site est en ligne sur https://multiservices75.github.io/hotte/
